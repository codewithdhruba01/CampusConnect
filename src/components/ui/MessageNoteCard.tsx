  ...
  return (
    <div className="relative mx-auto flex h-full w-full max-w-sm flex-col pt-8">
      ...
      <div className="relative flex h-full flex-col rounded-[2rem] border border-white/10 bg-[#222222] p-6 shadow-2xl">
        ...
        {/* Chat Bubbles Mockup */}
        <div className="relative mt-auto flex h-[116px] flex-col gap-4 overflow-hidden rounded-xl border border-white/5 bg-[#111111] p-4">
          {/* Bubble Left */}
          <motion.div
            initial={{ opacity: 0, x: -10 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="w-[85%] self-start rounded-2xl rounded-tl-sm bg-white/10 p-3 text-xs text-neutral-400"
          >
            <div className="mb-2 h-1.5 w-full rounded-full bg-white/20"></div>
            <div className="h-1.5 w-4/5 rounded-full bg-white/20"></div>
          </motion.div>
