  ...
  return (
    <footer className="relative z-20 px-4 py-10 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[#17191b] px-4 pb-7 pt-4 shadow-2xl sm:px-6 sm:pb-8 sm:pt-6">
        <div className="relative overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-[#ff123c] via-[#f50727] to-[#b90c18] px-6 py-8 sm:px-10 sm:py-10 lg:px-12">
          <div
            className="pointer-events-none absolute inset-0"
            style={{
              backgroundImage:
                "linear-gradient(90deg, rgba(255, 255, 255, 0.08) 0% 10%, rgba(255, 255, 255, 0.02) 10% 20%, rgba(128, 0, 12, 0.13) 20% 30%, rgba(255, 255, 255, 0.03) 30% 40%, rgba(104, 0, 10, 0.28) 40% 50%, rgba(88, 0, 10, 0.36) 50% 60%, rgba(128, 0, 12, 0.2) 60% 70%, rgba(255, 255, 255, 0.03) 70% 80%, rgba(144, 0, 14, 0.12) 80% 90%, rgba(255, 255, 255, 0.08) 90% 100%), linear-gradient(180deg, rgba(255, 255, 255, 0.08), transparent 45%, rgba(70, 0, 8, 0.2))",
            }}
          />
            ...
            <div className="max-w-sm">
              ...
              <div className="mt-7 flex items-center gap-3">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#e90d2e] transition-transform hover:scale-110"
                >
