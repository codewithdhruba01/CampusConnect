      ...
      >
        <motion.div layout className="flex items-center">
          <Link to="/" className="flex items-center gap-2 text-lg font-bold tracking-tight">
            ...
            <span className="text-base text-white">Campus Connect</span>
          </Link>
        </motion.div>
        ...
        <motion.div layout className="flex items-center gap-4">
          ...
          <Link to="/dashboard">
            <Button className="h-9 rounded-full bg-white px-5 text-sm font-medium text-black shadow-none transition-colors hover:bg-neutral-200">
              Get Started
            </Button>
          </Link>
        </motion.div>
