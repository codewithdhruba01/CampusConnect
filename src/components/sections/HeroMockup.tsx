          ...
          <div className="scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10 flex-1 overflow-y-auto bg-neutral-900/30 p-8">
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button className="flex items-center gap-1.5 rounded-md border border-white/10 bg-[#171717] px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-white/5 hover:border-white/20">
